...
#
get_filename_component(filename "C:/Users/Felipe/CLionProjects/Wiki/cmake-build-debug/_deps/nlohmann_json-tmp/json.tar.xz" ABSOLUTE)
get_filename_component(directory "C:/Users/Felipe/CLionProjects/Wiki/cmake-build-debug/_deps/nlohmann_json-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-nlohmann_json${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-nlohmann_json${i}")
